    ...
    public static async Task EnsureAsync(CatalogDbContext db, CancellationToken ct)
    {
        ...
        await TryAsync(db, """
            CREATE TABLE IF NOT EXISTS CourseQuizzes (
                Id TEXT NOT NULL CONSTRAINT PK_CourseQuizzes PRIMARY KEY,
                CourseId TEXT NOT NULL,
                Title TEXT NOT NULL,
            ...
            """, ct);
        await TryAsync(db, """
            CREATE TABLE IF NOT EXISTS CourseQuizAttempts (
                Id TEXT NOT NULL CONSTRAINT PK_CourseQuizAttempts PRIMARY KEY,
        ...
        await TryAsync(db, """
            CREATE TABLE IF NOT EXISTS CourseAssignments (
                Id TEXT NOT NULL CONSTRAINT PK_CourseAssignments PRIMARY KEY,
                CourseId TEXT NOT NULL,
                Title TEXT NOT NULL,
        ...
        await TryAsync(db, """
            CREATE TABLE IF NOT EXISTS CourseAssignmentSubmissions (
                Id TEXT NOT NULL CONSTRAINT PK_CourseAssignmentSubmissions PRIMARY KEY,
            ...
            """, ct);
        await TryAsync(db, """
            CREATE UNIQUE INDEX IF NOT EXISTS IX_CourseAssignmentSubmissions_AssignmentId_StudentId
            ON CourseAssignmentSubmissions (AssignmentId, StudentId);
            """, ct);
        await TryAsync(db, """
            CREATE TABLE IF NOT EXISTS LectureNotes (
                Id TEXT NOT NULL CONSTRAINT PK_LectureNotes PRIMARY KEY,
                CourseId TEXT NOT NULL,
                LectureId TEXT NOT NULL,
                StudentId TEXT NOT NULL,
                Body TEXT NOT NULL,
        ...
        await TryAsync(db, """
            CREATE TABLE IF NOT EXISTS CourseResources (
                Id TEXT NOT NULL CONSTRAINT PK_CourseResources PRIMARY KEY,
                CourseId TEXT NOT NULL,
                Title TEXT NOT NULL,
                Url TEXT NOT NULL,
